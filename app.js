...
const pins = [
  {img:"assets/inspo8.jpg",name:"Graphic warm",base:94,why:"低めのソファと大きめラグで、視線が散らかりにくい。8畳でもまとまりを作りやすい構成です。",tags:["白いローソファ","柄ラグ","オレンジ照明"],sense:"白と木をベースに、オレンジを少量だけ使っているので、物が多くても全体がまとまって見えます。"},
  {img:"assets/inspo2.jpg",name:"Retro city pop",base:91,why:"家具の高さが低く、差し色を点で使っているので狭い部屋でも圧迫感が出にくいです。",tags:["低めソファ","丸い照明","赤・オレンジ"],sense:"色を全部そろえるのではなく、黒を土台にしてオレンジを繰り返しているのがポイントです。"},
  {img:"assets/inspo6.jpg",name:"Cozy lighting",base:88,why:"家具数を絞り、照明と植物で雰囲気を作っているので日本の賃貸にも落とし込みやすいです。",tags:["植物2〜3点","間接照明","家具量少なめ"],sense:"天井照明だけに頼らず、低い位置に光源を増やすことで奥行きが生まれています。"},
  {img:"assets/inspo3.jpg",name:"Airy mid-century",base:86,why:"壁際に家具を寄せて中央の余白を残しているため、長方形の部屋と相性が良いです。",tags:["木の家具","ロー家具","中央の余白"],sense:"視線が奥まで抜けるように、大きい家具を低く抑えているのが広く見える理由です。"},
  {img:"assets/inspo5.jpg",name:"Colorful gallery",base:82,why:"アートや照明で個性を出している一方、大型家具は控えめ。賃貸でも小物から真似しやすいです。",tags:["アート","小型照明","色の反復"],sense:"カラフルでも色をバラバラに置かず、赤・黄・緑を複数箇所で繰り返すとまとまります。"},
  {img:"assets/inspo4.jpg",name:"Warm books & plants",base:80,why:"壁面を活用して床を空ける考え方が、小さめの部屋でも使いやすいです。",tags:["壁面アート","植物","縦収納"],sense:"高さのある本や植物を壁側に集めることで、床面の余白を確保しています。"}
];
